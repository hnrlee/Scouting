...
//		{
//			EventRequest teamEvents = this.getEvents(team.getTeamNumber());
//			for (Event event : teamEvents.getEvents())
//			{
//				EventSchedule eventSchedule = this.getSchedule(event.getCode(), team.getTeamNumber());
//				ScoreDetailRequest scoresQual = this.getMatchDetails(event.getCode(), team.getTeamNumber(), "qual");
//				ScoreDetailRequest scoresPlayoff = this.getMatchDetails(event.getCode(), team.getTeamNumber(), "playoff");
//				MatchScore score;
//				int scheduleIndex = 0;
...
//	}
	...
	public EventRequest getEvents()// gets all the events
	{
	...
	public EventRequest getEvents(int teamNumber)// gets all the events
	{
	...
	public TeamRequest getTeams()// gets all the teams at the main event
	{
		String json = this.makeRequest("https://frc-api.firstinspires.org/v2.0/2016/teams","teams", true);
		TeamRequest teams = new Gson().fromJson(json,TeamRequest.class);
		return teams;
	}

	public ScoreDetailRequest getMatchDetails(String event, int teamNumber, String level)// gets info about match of team
	{
		...
		return new Gson().fromJson(json, ScoreDetailRequest.class);
	}
